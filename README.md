...
* I manually organize all data in a [Google Spreadsheet](https://docs.google.com/spreadsheets/d/1VqYCMrkaD-mEDYWRfXPB9lRzMfKmxkS93l1eOUMThkE)
  * There are pages for running events (by year), running groups, the [local parkrun](https://parkrun.com.de/dietenbach),  and special pages listing tags & running series
